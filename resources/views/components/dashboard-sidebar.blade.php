...
<!-- <aside class="fixed inset-y-0 left-0 z-40 hidden w-72 flex-col bg-[#0b3a67] text-white lg:flex">
    ...
    <nav class="flex-1 space-y-2 px-5 py-7">
        ...
        <a href="{{ route('admin.referrals.index') }}" class="block rounded-xl px-4 py-3 text-gray-200 transition hover:bg-white/10">
            All Referrals
        </a>
        <a href="{{ route('admin.withdrawals.index') }}" class="block rounded-xl px-4 py-3 text-gray-200 transition hover:bg-white/10">
